...
class Scraper
  ...
  def self.scrape_index_page(index_url)
    ...
    #we're looking for name, location, and their page. 
    array=[] 
    ...
    array << hash
    #page.css("div.student-card h4") = name 
    #page.css("div.student-card p") = location
    #page.css("div.student-card a").attr("href") = link
  end
  array
  #always have to return the right value ;) 
  end
